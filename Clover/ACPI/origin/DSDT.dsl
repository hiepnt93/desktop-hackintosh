 ...
 *
 * Disassembly of DSDT.aml, Tue Jul 19 20:08:28 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C9A2 (51618)
 *     Revision         0x02
 *     Checksum         0x25
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("DSDT.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    /*
     * iASL Warning: There were 12 external control methods found during
     * disassembly, but only 0 was resolved (12 unresolved). Additional
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDC87DC18, 0x02B2)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDC77EE18, 0x10)
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xDC869018, 0x00FC)
            ...
            {
                OperationRegion (GDAD, SystemMemory, 0xDC867018, 0x00D8)
